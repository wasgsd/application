...
module.exports = function(sequelize){
  ...
  this.promise_leaves_to_be_processed = function(){
    ...
    .then(function(leaves){
      return Promise.resolve(leaves).map(function(leave){
  ...
  this.calculate_total_number_of_days_n_allowance = function(year) {
  ...
  this.validate_leave_fits_into_remaining_allowance = function(args){
    ...
    .then(function(employee){
      ...
      if (
        employee.calculate_number_of_days_available_in_allowance(
          year.format('YYYY')
        )
          -
